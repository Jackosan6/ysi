...
lito_tbl <- fread("./data/lito_tbl.tsv", header = T)

sapto_tbl <- fread("./data/sapto_tbl.tsv", header = T)

medicare_tbl <- fread("./data/medicare_tbl.tsv", header = T)

income_tax_rates_tbl <- fread("./data/income_tax_rates_tbl.tsv", header = T)
